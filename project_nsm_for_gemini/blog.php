...
<title>Blog - Cele Mai Recente Articole</title>
</head>
...
<div class="blog_list_page">
    ...
    <section class="hero_blog_section">
        <div class="blog_hero_content">
            <h1>Cele Mai Recente Articole</h1>
            <p>Perspective, tutoriale și gânduri despre dezvoltare web, automatizare și experiențe digitale.</p>
        </div>
    </section>
                ...
                ?>
                    <div class="blog_post_card">
                        ...
                        <div class="blog_post_card_content">
                            ...
                            <a href="blog_post.php?slug=<?php echo $post['slug']; ?>" class="see_more_btn">Citește Articolul</a>
                        </div>
                    </div>
                <?php
                    }
                } else {
                    echo '<div class="no-posts-message">Niciun articol de blog disponibil în acest moment. Revino în curând!</div>';
                }
                ?>
            </div>
        </div>
